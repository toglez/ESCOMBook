				...
				<div class="module_content"><center>
					...
					?>
								...
								<?php } else { echo "<br>";}?>
					 				...
					 				<h4>
									Id Usuario: <input type="text" name="id" placeholder="IdUsuario" value="<?php echo $dato0;?>" readonly> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									Id Publicacion: <input type="text" name="idPublicacion" placeholder="IdPublicacion" value="<?php echo $dato1;?>" readonly> <br><br>
						...
						<fieldset>
							...
							<textarea rows="4" required ><?php echo $dato2;?></textarea>
						</fieldset>
					  			
					  				<br><br>

									<input id="boton" class="btn" type="submit" value="Enviar"> &nbsp;
